...
exports.getAverageRating = async (req, res) => {
  try {
    ...
    // we want the average of all those ratings from the RatingAndReview table whose course = courseId above.
    // the sql command for it would be:
    // select avg(rating) as averageRating from RatingAndReview where course = courseId;
    // now all we need to do is find the mongodb query equivalent of the above sql query:
